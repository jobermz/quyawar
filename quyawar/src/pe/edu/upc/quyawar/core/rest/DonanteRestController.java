...
public class DonanteRestController {
   ...
   public ResponseEntity<List<Donante>> listAllDonantes() throws Exception {
       ...
       if(donantes.isEmpty()){
           return new ResponseEntity<List<Donante>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
       }
       return new ResponseEntity<List<Donante>>(donantes, HttpStatus.OK);
   }


   //-------------------Retrieve Single Donante--------------------------------------------------------
   ...
   //------------------- Delete All Donantes --------------------------------------------------------
//    
//   @RequestMapping(value = "/donante/", method = RequestMethod.DELETE)
//   public ResponseEntity<Donante> deleteAllDonantes() throws Exception {
//       System.out.println("Deleting All Donantes");
//
//       donanteService.deleteAllDonantes();
//       return new ResponseEntity<Donante>(HttpStatus.NO_CONTENT);
//   }
